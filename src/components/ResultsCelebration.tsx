  ...
  return (
    <div className="results-celebration-card">
      ...
      <p className="results-celebration-text">
        Первые 500 сотрудников, ответивших верно, получат подарки! Списки
        победителей будут опубликованы после 15 сентября. Организаторы свяжутся
        и расскажут, как получить подарок. Напоминаем, что сотрудник может
        получить только 1 подарок, вне зависимости от количества выигранных
        викторин.
      </p>
